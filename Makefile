...
version ?= $(shell grep 'Plugin-Version' plugins/nf-nextpie/src/resources/META-INF/MANIFEST.MF | awk '{ print $$2 }')
...
install:
	...
	rm -rf ${HOME}/.nextflow/plugins/nf-nextpie-${version}
	cp -r build/plugins/nf-nextpie-${version} ${HOME}/.nextflow/plugins/
